...
- CI: Fix PKGBUILD source URL to use VERSION variable instead of pkgver
- CI: Add renovate config for dependency updates

## [v0.1.1](https://github.com/forkline/swaybeam/tree/v0.1.1) - 2026-04-02

### Fixed

- CI: Remove cross-compilation targets, only support x86_64 Linux
- CI: Use bash script instead of Rash for PKGBUILD generation
